...
class DirectoryUser(Base):
    ...
    usage_location: Mapped[str | None] = mapped_column(Text)
    employee_id: Mapped[str | None] = mapped_column(Text)
    employee_type: Mapped[str | None] = mapped_column(Text)
    ...
    ext2: Mapped[str | None] = mapped_column(Text)
    ext3: Mapped[str | None] = mapped_column(Text)
    ext4: Mapped[str | None] = mapped_column(Text)
    ext5: Mapped[str | None] = mapped_column(Text)
    ext6: Mapped[str | None] = mapped_column(Text)
    ext7: Mapped[str | None] = mapped_column(Text)
    ext8: Mapped[str | None] = mapped_column(Text)
    ext9: Mapped[str | None] = mapped_column(Text)
    ext10: Mapped[str | None] = mapped_column(Text)
    ext11: Mapped[str | None] = mapped_column(Text)
    ext12: Mapped[str | None] = mapped_column(Text)
    ext13: Mapped[str | None] = mapped_column(Text)
    ext14: Mapped[str | None] = mapped_column(Text)
    ext15: Mapped[str | None] = mapped_column(Text)
